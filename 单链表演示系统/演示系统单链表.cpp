...
int main(){
    ...
    while(op){
        ...
        printf("          ----------------------------------------------------------------------------\n");
        printf("    	  1. InitList    线性表初始化         13. sortList         线性表排序\n");
        printf("    	  2. DestroyList 线性表销毁           14. SaveList         线性表文件保存\n");
        printf("    	  3. ClearList   线性表清空           15. LoadList         线性表文件录入\n");
        printf("    	  4. ListEmpty   线性表判空           16. AddList          多线性表添加\n");
        printf("    	  5. ListLength  线性表获取长度       17. RemoveList       多线性表删除\n");
        printf("    	  6. GetElem     线性表元素获取       18. LocateList       多线性表位置查找\n");
        printf("          7. LocateElem  线性表元素查找       19. TraverseList     多线性表遍历\n");
        printf("          8. PriorElem   线性表元素前驱获取   20. SelectList       线性表操作选择\n");
        printf("          9. NextElem    线性表元素后继获取   21. reverseList      线性表翻转\n");
        printf("          10. ListInsert 线性表元素插入       22. RemoveNthFromEnd 移除倒数元素\n");
        printf("          11. ListDelete 线性表元素删除 \n");
        printf("          12. ListTraverse   线性表遍历 \n");
        printf("    	  0. Exit        退出\n");
        printf("          ----------------------------------------------------------------------------\n");
